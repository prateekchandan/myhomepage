...
<html lang="en">
	<head>
		...
		<title>Prateek Chandan - Homepage</title>
	...
	<body data-spy="scroll" data-target="#navbar-example">	 
		...
		<div class="background-white">
			<div id="profile" class="container">
				<h2>Profile</h2>
<p class="lead">I&#039;m a Computer Science 3rd Year Under Graduate at <a href="http://www.iitb.ac.in">IIT Bombay</a></p>
...
<div class="row">
	...
	<div class="col-md-4">
		...
		<p>
			...
			15<sup>th</sup> March<br />
			<strong>Location:</strong><br />
			Hostel 9, IIT Bombay,Mumbai		</p>
...
<div class="experiences">
	...
	<div class="experience row">
		...
		<div class="col-md-8">
			<p>
				<strong>Own project - Developer</strong>
				<span class="hidden-phone">
					Create a local game of the annual festival 'Carnaval'. Design was made by friends of my, Mals (www.studiomals.com). It went a bit viral the first day, with over 8000 games played!				</span>
				<span class="experience-details">
					<span class="location">
						<span class="glyphicon glyphicon-map-marker"></span>
						's-Hertogenbosch					</span>
					...
					<span class="link">
						<span class="glyphicon glyphicon-link"></span>
						<a href="http://www.oetelspel.nl/" target="_blank">http://www.oetelspel.nl/</a>
					</span>
	...
	<div class="experience row">
		<div class="col-md-4">
			<h4>SOAP - Independent Hair Designers</h4>
			<p class="experience-period">
				Aug 2007				- 
				current			</p>
		</div>
		<div class="col-md-8">
			<p>
				<strong>Freelance - Developer / Designer</strong>
				<span class="hidden-phone">
					SOAP is a local hairdresser in 's-Hertogenbosch. I design, develop and manage their website. Every couple of years I re-design their site and I recently updated their CMS to Wordpress, combined with a custom made Bootstrap theme to make it completely responsive. 				</span>
				<span class="experience-details">
					<span class="location">
						<span class="glyphicon glyphicon-map-marker"></span>
						's-Hertogenbosch					</span>
					...
					<span class="link">
						<span class="glyphicon glyphicon-link"></span>
						<a href="http://www.soaphair.nl/" target="_blank">http://www.soaphair.nl/</a>
					</span>
...
<div class="row">
	...
	<div class="col-md-6">
		<ul class="no-bullets">
			...
			<li>
				<span class="ability-title">Bootstrap 2/3</span>
				<span class="ability-score">
...
<div class="row">
	...
	<div class="col-md-6">
		<ul class="no-bullets">
			...
			<li>
				<span class="ability-title">Mac (2 years)</span>
				<span class="ability-score">
			...
			<li>
				<span class="ability-title">Coda (1 year)</span>
				<span class="ability-score">
...
<div class="row">
	...
	<div class="col-md-8 interest-content">
		<h3>Algorithms</h3>
		<p>
			I love solving riddles and problems and building stuff from scratch. My strong suit is that I don't give up without a fight. When trying to find the solution to a problem, I will not quit until I find at least one. The satisfaction I get from solving a problem can really make my day.		</p>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-8 interest-content">
		<h3>Music</h3>
		<p>
			I can listen to music all day. I have a varied taste of music and I listen to it at work, during sports, riding my bike, on the train... I play guitar myself and would love to own a drum-kit some day.		</p>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-8 interest-content">
		<h3>My Cats</h3>
		<p>
			If you look up my social networks, you'll surely come across one of my cats. Because what is the internet without cats? Nothing, right? And I'm an internet man, so one and one makes two.		</p>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-8 interest-content">
		<h3>Sports</h3>
		<p>
			I couldn't live without sports. In the weekend you will find me riding my mountainbike - just check out my Runkeeper. Once or twice a week, you'll find me in the gym or at the tracks to train my pole vaulting. I just love the adrenaline rush!		</p>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-8 interest-content">
		<h3>Travel</h3>
		<p>
			When I was 19 I traveled by plane for the first time, and after that I was hooked. I went to the United States twice, Surinam, Greece, Malta, the Canary Islands and more. But as much as I love the sun, I also love going to the Alps for some snowboarding.		</p>
	</div>
</div>
...
<div class="text-center">
	<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://pascalvangemert.nl/?ref=twitter" data-via="pascalvgemert">Tweet</a>
